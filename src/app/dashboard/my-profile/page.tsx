...
const Page = () => {
  ...
  return (
    <>
      ...
      <div className="flex  flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 justify-between rounded-md border-[1px] border-gray-400 bg-gray-800 px-12  p-8  ">
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-gray-400 bg-gray-800 p-8 px-12">
